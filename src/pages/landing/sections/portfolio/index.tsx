  ...
  return (
    <section id="portfolio" className="section">
      ...
      <div className="section-des">
        Don't be a stranger! We love hearing from our listeners!
      </div>
      <div className="section-des">
        <h3>Book Overflow</h3>
      ...
      <div className="section-des">
        <h3>Carter Morgan</h3>
        <SocialIcon bgColor="black" network="twitter" url="https://twitter.com/cartermorgan" className="icon-margin"/>
